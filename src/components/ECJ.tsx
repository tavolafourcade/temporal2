      ...
      <div style={{ width: "30%" }}>
        ...
        */}
        ...
        <div className="flex flex-col w-36">
          {/* <FolderList onSelectFolder={handleSelectFolder} showAll={true} /> */}
          ...
          {(user?.uid === CONSTANTS.JACOB_ID ||
            ...
            user?.uid == CONSTANTS.NABEEL_ID ||
            user?.uid == CONSTANTS.RYAN_ID ||
            user?.uid == CONSTANTS.RAPH_ID ||
            user?.uid == CONSTANTS.CHANELLE_ID ||
            user?.uid == CONSTANTS.JOEY_ID ||
            user?.uid == CONSTANTS.JOE_ID ||
            user?.uid == CONSTANTS.EK_ID ||
            user?.uid == CONSTANTS.ELIZA_ID ||
            user?.uid == CONSTANTS.LUIS_ID ||
            user?.uid == CONSTANTS.YOON_ID ||
            user?.uid == CONSTANTS.CHELSEA_ID) && (
            <SetterList
              setters={allUsers}
