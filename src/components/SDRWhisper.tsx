...
const idToAliasMapping = {
  CD7Hfm80x4ctxv0dgOWt: "SDR Whisperer",
...
export default function SDRWhisperer() {
      ...
      <div style={{ width: "30%" }}>
        ...
        */}
        ...
        <div className="flex flex-col w-36">
          ...
          {(user?.uid === CONSTANTS.DYLANSDR ||
            user?.uid == CONSTANTS.SAMSDR ||
            user?.uid == CONSTANTS.BRENDEN_ID ||
            user?.uid === CONSTANTS.ROB_REAL_ID ||
            user?.uid == CONSTANTS.MARCUS_ID) && (
            <SetterList
              setters={allUsers}
