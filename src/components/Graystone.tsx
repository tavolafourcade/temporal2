...
const idToAliasMapping = {
  xva7RLZc0947qgQ4DoaS: "Graystone",
...
export default function Graystone() {
      ...
      <div style={{ width: "30%" }}>
        ...
        */}
        ...
        <div className="flex flex-col w-36">
          ...
          {(user?.uid === CONSTANTS.LUKEF_ID ||
            user?.uid == CONSTANTS.GRAYSTONE_ID ||
            user?.uid == CONSTANTS.AIDAN_ID ||
            user?.uid == CONSTANTS.DEVON_ID ||
